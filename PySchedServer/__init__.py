...
from PySchedServer.DatabaseManagement import SqliteManager
from PySchedServer.Scheduler import PyScheduler
from PySchedServer.NetworkManagement import NetworkManager
from PySchedServer.MessageHandler import MessageHandler

from Common.Communication.CommandBuilder import CommandBuilder
from Common.DataStructures import Job, User, JobState, Program
...
class PySchedServer(object):
    ...
    def checkForPrograms(self, workstation):
        '''
